function [Zset] = preprocess_getZset(win_width_s,dt,fs,x,freqrange,peak_thr,GS)
...
% GS = option for Gaussian Smooting- GS = 0 (default) is no Gaussian
% smoothing, GS = 1 applies Gaussian smooting.
